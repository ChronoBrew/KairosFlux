...
// 机读错误码分类学的 0x3xxx 段（BANLV-2 RFC §10.3）：schema 校验失败按具体原因
...
// 的取值刻意与 bannet/codec.ErrCodeSchemaValidation 一致（都是 0x3001）：后者是
...
// 则返回其 Code；否则返回 fallback（调用方通常传 bannet/codec.ErrCodeSchemaValidation
