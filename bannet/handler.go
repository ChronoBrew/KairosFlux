...
// HookAction 是 PreHandle 钩子的处置决定，参见 bannet/handler.HookAction。
...
// BaseRouter 是 Handler 的默认空实现，参见 bannet/handler.BaseRouter。
