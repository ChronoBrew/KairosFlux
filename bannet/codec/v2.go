...
// BANLV v2 帧格式（docs/rfc/BANLV-2.md §2/§3）。本文件是纯新增：不修改本包
...
var ErrUnsupportedV2Version = errors.New("codec: unsupported BANLV v2 minor version")
